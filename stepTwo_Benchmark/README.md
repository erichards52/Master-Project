...
**ALL CLASSIFIERS WERE RUN UNDER THEIR RESPECTIVE DEFAULT SETTINGS**
...
For `samples.L.txt` and `samples.R.txt` please have a look at the CLARK manual for further explanation.
