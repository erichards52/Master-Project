...
Invoking the command `makeDB.sh -e -v -t 12` will automatically create a Kaiju database.
...
Please have a look at metaClarkOutAllSamples.sh or metaClarkOutAllSamplesFull.sh for an example. 
