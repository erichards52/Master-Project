...
Table 1 is details platforms used by all datasets present on the SRA. Figure 1 is a barplot which represents this information. The number of datasets which did not provide a platform is included in both the table and the figure (NA). Figure 2 is a line graph which represents the number of bases sequenced by each platform per year (not cumulative).
...
Table 3 exhibits the total number of each species of rat failling under the *Rattus* genus present on the SRA.
```{r echo = FALSE}
#Organism table
